            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.timeout(100000);
                            return [4 /*yield*/, (0, supertest_1.default)(app_1.app).get("/api/products")];
                        case 1:
                            res = _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, supertest_1.default)(app_1.app).get("/api/product/".concat(id))];
                        case 1:
                            res = _a.sent();
                            data = res.body.data;
                            (0, chai_1.expect)(res.status).to.equal(200);
                            (0, chai_1.expect)(data).to.have.property("PartNumber", "C060082R118A");
                            (0, chai_1.expect)(data).to.have.property("Description", "PTP 820 RFU-C,6HGHz,TR340B,Ch5W8,Lo,6581-6739MHz");
                            return [2 /*return*/];
                    }
                });
            });
