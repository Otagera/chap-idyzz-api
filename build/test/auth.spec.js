            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        (0, chai_1.expect)(loginWrongUsernameRes.status).to.equal(401);
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        (0, chai_1.expect)(loginWrongPasswordRes.status).to.equal(402);
                        return [2 /*return*/];
                }
            });
        }); });
        it("should return tokens after login in", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        loginRes = _a.sent();
                        (0, chai_1.expect)(loginRes.status).to.equal(200);
                        return [2 /*return*/];
                }
            });
        }); });
